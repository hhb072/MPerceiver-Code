...
if __name__ == '__main__':
    enc = Encoder(ch=128,out_ch=3,ch_mult=(1,2,4,4),num_res_blocks=2,attn_resolutions=[],dropout=0.0,in_channels=3,resolution=512,z_channels=4).cuda()
    x = torch.randn((1,3,512,512)).cuda()
    results = enc(x,True)[1]
